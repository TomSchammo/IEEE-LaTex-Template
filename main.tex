...
BibTex only generates references if the keys are used.
Some in the manual reference list were not, so to make them still appear:
\cite{b8}\cite{b9}\cite{b10}\cite{b11}

Though note that they are listed in the order that they first appear, which in this case
appears to be b7 \cite{b7}.
